...
files will be created:
  ...
  conf/
    ...
    admin.properties           (net socket for administration)
    ejbd.properties            (net socket for ejb invocations)
    hsql.properties            (net socket for hsql client access)
    httpejbd.properties        (net socket for ejb invocations over http)
    telnet.properties          (net socket for telnet "server")
...
DETAILS ABOUT EACH FILE
 ...
 ABOUT conf/openejb.xml
    ...
    configuration.  When sending net.requests for help to the users list or
